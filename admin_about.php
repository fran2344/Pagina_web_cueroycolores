                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="uploader_about.php" method="POST"  role="form">
                                        <div class="form-group">
                                            <label>Misión:</label></br>
                                            <input type="text" name="mision" value="<?php echo $mision1; ?>" class="text">
                                        </div>
                                        <div class="form-group">
                                            <label>Visión:</label></br>
                                            <input type="text" name="vision" value="<?php echo $vision1; ?>" class="text">
                                        </div>                                        
                                        <div class="form-group">
                                            <label>Historia:</label></br>
                                            <textarea name="historia"><?php echo $historia1; ?> </textarea>
                                        </div> 
                                        <input type="submit" value="Aceptar Cambios" class="btn btn-default"/>
                                    </form>
                                </div>
                            </div>
                        </div>
