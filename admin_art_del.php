...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Eliminar de categoria</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-heading">
                            <select name="categorias" onchange="location=this.value">
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                    <OPTION VALUE=<?PHP echo "admin_art_del_menu.php?dato=0&pagina=".$pagina."&cat=".mysql_result($categorias,$iterador, 'idCATEGORIA'); ?> >
