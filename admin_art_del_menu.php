...
AND CATEGORIA_idCATEGORIA=".$categoria_g."
                        ...
                        <div class="panel-heading">
                            ...
                            {
                                $pag_ant=$pagina-1;
                                echo "<a href='admin_art_del_menu.php?dato=0&pagina=".$pag_ant."&cat=".$categoria_g."'><IMG SRC='imgtot/atras.gif'></IMG></a>";
                            }
                            echo  $pagina . " / " . $total_paginas;
                            if($pagina<$total_paginas)
                            {
                                $pag_sig=$pagina+1;
                                echo "<a href='admin_art_del_menu.php?dato=0&pagina=".$pag_sig."&cat=".$categoria_g."'><IMG SRC='imgtot/adelante.gif'></IMG></a>";
                            }        
                            ?>
                        </div>
        ...
        ?>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form  enctype="multipart/form-data" action="del_articulo.php" method="POST"  role="form">
