...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Eliminar Colección</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
        ...
        ?>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form  action="del_categoria.php" method="POST">
                                        <div class="form-group">
                                            <label><?php echo mysql_result($articulos,$iterador, 'nombre'); ?></label></br>
        ...
        ?>
            ...
            {
            ?>
            <p><b>Error al eliminar categoria</b></p>
            <?php   
            }else if($dato==='0')
            {}
            else
            {
            echo "<script>alert('Se ha eliminado la categoria correctamente')</script>";
            }
