...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sección de Administrador</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form  enctype="multipart/form-data" action="uploader_logo.php" method="POST"  role="form">
                                        <div class="form-group">
                                            <img src=<?php echo $logo ?> width='150' height='150'/>
                                        </div>
                                        <div class="form-group">
                                            <label>Ruta de imagen</label>
                                            <input name="uploadedfile2" type="file" class="browse" />
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Mensaje, descripción y cuenta de correo
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form  action="" method="POST"  role="form">
                                        <div class="form-group">
                                            <label>Mensaje</label>
                                            <input type="text" name="mensaje" value="<?php echo $msj ?>" />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Correo de Cuero & Colores</label>
                                            <input type="text" name="correo" value="<?php echo $correo ?>" />
                                        </div>                                        
                                        <input type="submit" value="Asignar" name="probar" class="btn btn-default"/>
                                    </form>
                                </div>
                            </div>
                        </div>
