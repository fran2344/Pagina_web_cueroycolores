...
<body>
    ...
    <div id="wrapper">
        ...
        {
            $pag_ant=$pagina-1;
            echo "<a href='delto_categoria_menu.php?dato=0&pagina=".$pag_ant."&cat=".$categoria_g."'>
        ...
        {
            $pag_sig=$pagina+1;
            echo "<a href='delto_categoria_menu.php?dato=0&pagina=".$pag_sig."&cat=".$categoria_g."'>
        ...
        ?>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form  enctype="multipart/form-data" action="uploader_delto.php" method="POST"  role="form">
                ...
                <?php
                    $query = "select count(*) as valor from CATEGORIA C WHERE EXISTS(SELECT * FROM ARTICULO_CATEGORIA WHERE
                                CATEGORIA_idCATEGORIA=C.idCATEGORIA AND ARTICULO_idARTICULO=".$tempo1.");";
                    $categoria_total = mysql_query($query);
                    $query = "select * from CATEGORIA C WHERE EXISTS(SELECT * FROM ARTICULO_CATEGORIA WHERE
                                CATEGORIA_idCATEGORIA=C.idCATEGORIA AND ARTICULO_idARTICULO=".$tempo1.");";
        ...
        ?>
            ...
            {
            echo "<script>alert('Articulo removido de categoria')</script>";
            }
