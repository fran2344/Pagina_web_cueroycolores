...
<html>
	...
	<body>
		...
		?>
		<div class="logo2">
			<form enctype="multipart/form-data" action="uploader_delto.php" method="POST">
				<img src=<?php echo mysql_result($articulos,$iterador, 'imagen_t'); ?> title="gaia" width='150' height='150' />
				...
				<input type="submit" value="Quitar articulo" />
			</form>
		</div>		
		<?php	
		}
		?>
			...
			{
			echo "<script>alert('Se ha agregado el articulo')</script>";
			}
